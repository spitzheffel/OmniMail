export const enICloud: Record<string, string> = {
  ...
  '提交时由 Apple 生成地址': 'Generated by Apple when submitted',
  '提交时直接创建': 'Created directly on submit',
  ...
  'Apple Account 登录': 'Apple Account sign-in',
  'Apple ID 密码': 'Apple ID password',
  '连接 Apple Account': 'Connect Apple Account',
  'Apple Account 登录后优先使用新接口创建隐藏邮箱；密码只用于本次请求。':
    'After sign-in, the new API is preferred for Hide My Email creation. The password is used only for this request.',
  'Apple Account 已连接': 'Apple Account connected',
  'Apple Account 已移除': 'Apple Account removed',
  'Apple Account 登录态已刷新': 'Apple Account session refreshed',
  '刷新登录态': 'Refresh session',
  '移除 Apple Account': 'Remove Apple Account',
  '已连接': 'Connected',
  '需要重新登录': 'Sign-in required',
  '密码只用于本次登录请求，不会保存或回传。':
    'The password is used only for this sign-in request and is never stored or returned.',
  '新接口创建已启用，可减少无效预览请求。':
    'Direct creation is enabled, reducing unnecessary preview requests.',
  '登录态有效至 {expiresAt}': 'Session valid until {expiresAt}',
  '受信任设备验证码': 'Trusted-device verification code',
  '请输入受信任设备上的验证码': 'Enter the code shown on your trusted device',
  '验证码将在 {expiresAt} 前有效': 'The code is valid until {expiresAt}',
  '验证码有效期约 10 分钟。': 'The code is valid for about 10 minutes.',
  '验证并完成登录': 'Verify and finish sign-in',
  ...
  '配置 Cookie 或 Apple Account 后可创建隐藏邮箱': 'Configure cookies or an Apple Account to create Hide My Email addresses',
  '创建': 'Create',
  '同步': 'Sync',
  '全部邮件': 'All messages',
  ...
  '至少配置一种：主邮箱与应用专用密码用于收信；Cookie 或 Apple Account 用于管理隐藏邮箱。':
    'Configure at least one method: use the primary address and app-specific password for mail, or cookies or an Apple Account for Hide My Email management.',
  '账号名称': 'Account name',
  ...
  '创建通道': 'Creation channel',
  '创建数量': 'How many',
  '创建项目 {count}/{max}': 'Creating {count}/{max}',
  '基础标签（可选）': 'Base label (optional)',
  '增加一个': 'Add one',
  '减少一个': 'Remove one',
  '加到上限': 'Fill to limit',
  '将依次命名为 {first} … {last}': 'They will be named {first} … {last}',
  '留空标签时由 Apple 自动命名。': 'Leave the label empty to let Apple name them.',
  '自动': 'Auto',
  '新接口': 'New API',
  '旧接口': 'Legacy API',
  ...
  '另有 {skipped} 个因额度或取消未创建。':
    '{skipped} more were not created because of the budget or cancellation.',
  '新接口 {apple} 个 · 旧接口 {web} 个': '{apple} via the new API · {web} via the legacy API',
  'Apple Account 会在提交时直接创建地址；本小时剩余额度显示在表单里。':
    'Apple Account creates addresses directly on submit. This hour\'s remaining budget is shown in the form.',
  '预览 Apple 生成的地址，确认后再创建；本小时剩余额度显示在表单里。':
    'Preview the address Apple suggests before creating it. This hour\'s remaining budget is shown in the form.',
  'iCloud 无法保留隐藏邮箱。': 'iCloud could not reserve the Hide My Email address.',
  'iCloud 已达到当前隐藏邮箱创建上限，请稍后再试。':
    'iCloud has reached its current Hide My Email creation limit. Try again later.',
  '本小时 Apple Account 创建额度已用完，请稍后再试。':
    'This hour\'s Apple Account creation budget is used up. Try again later.',
  '本小时 iCloud Cookie 创建额度已用完，请稍后再试。':
    'This hour\'s iCloud cookie creation budget is used up. Try again later.',
}
