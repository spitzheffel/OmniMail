export const enICloud: Record<string, string> = {
  ...
  'Apple Account 会在提交时直接创建地址，一次最多提交 {max} 个项目。':
    'Apple Account creates addresses directly on submit, with up to {max} items per batch.',
  'Apple Account 通道会在提交时直接生成地址，一次最多提交 {max} 个项目。':
    'The Apple Account channel generates addresses directly on submit, with up to {max} items per batch.',
