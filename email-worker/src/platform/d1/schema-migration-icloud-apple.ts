...
export const ICLOUD_APPLE_ACCOUNT_RECOVERY = {
  ...
  statements: [
    ...
    `CREATE TABLE IF NOT EXISTS icloud_auth_challenges (
      id TEXT PRIMARY KEY,
    ...
    `CREATE INDEX IF NOT EXISTS idx_icloud_auth_challenges_expiry ON icloud_auth_challenges(expires_at)`,
    `CREATE INDEX IF NOT EXISTS idx_icloud_auth_challenges_owner ON icloud_auth_challenges(user_id, account_id)`,
  ],
} as const
